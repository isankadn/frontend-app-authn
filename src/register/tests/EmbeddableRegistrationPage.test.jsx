...
describe('RegistrationPage', () => {
  ...
  describe('Test Registration Page', () => {
    ...
    it('should run username frontend validations', () => {
      const payload = {
        name: 'John Doe',
        username: 'aquraish@2u.com',
    ...
    it('should run email frontend validations', () => {
      const payload = {
        name: 'John Doe',
        username: 'aquraish@2u.com',
        email: 'as',
    ...
    it('should click on email suggestion in case suggestion is avialable', () => {
      const registrationPage = mount(reduxWrapper(<IntlEmbedableRegistrationForm {...props} />));
      registrationPage.find('input[name="email"]').simulate('focus');
      registrationPage.find('input[name="email"]').simulate('blur', { target: { value: 'ahtesham@gmail.co', name: 'email' } });

      registrationPage.find('a.email-suggestion-alert-warning').simulate('click');
      expect(registrationPage.find('input#email').prop('value')).toEqual('ahtesham@gmail.com');
    });
